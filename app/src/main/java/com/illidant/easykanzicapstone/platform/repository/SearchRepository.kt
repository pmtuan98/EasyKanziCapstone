...
class SearchRepository (
    private val remote: SearchDataSource.Remote) : SearchRepositoryType
{
    override fun searchKanji(request: SearchRequest): Call<SearchResponse> = remote.searchKanji(request)
